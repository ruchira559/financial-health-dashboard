...
2.  **Data Typing:** Ensured all financial metrics are set to Fixed Decimal for currency accuracy.
...
## How to Use
1.  Download the `financialDashboard.pbix` file.
2.  Open in **Power BI Desktop**.
3.  If prompted, update the data source path to point to the CSV file.
